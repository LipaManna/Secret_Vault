...
const AddSecret = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const existingSecrets = JSON.parse(localStorage.getItem('secrets') || '[]');
      const newSecret = {
      ...
      localStorage.setItem('secrets', JSON.stringify(existingSecrets));
      
      // Refresh the table by triggering a reload
  ...
  return (
    <>
        <Button variant="primary" onClick={handleShow}>Add Secret</Button>
